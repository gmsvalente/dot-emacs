...
(message "*** Old %d gc-cons-threshold before early-init ***" gc-cons-threshold)
(message "*** Old %.2f gc-cons-percentage before early-init ***" gc-cons-percentage)
...
(message "*** Using %d gc-cons-threshold on early-init ***" gc-cons-threshold)
(message "*** Using %.2f gc-cons-percentage on early-init ***" gc-cons-percentage)
